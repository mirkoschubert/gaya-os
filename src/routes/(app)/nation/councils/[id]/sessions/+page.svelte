...
<div class="space-y-6">
  <div class="flex items-center justify-between">
    ...
    <Button size="sm" href="/nation/councils/{data.councilId}/sessions/new">
      <Plus class="size-4" />
      New Session
    </Button>
  </div>
      ...
      {#each upcoming as session}
        <Card.Root>
          <Card.Content class="flex items-center justify-between p-4">
            <div>
              <a href="/nation/councils/{data.councilId}/sessions/{session.id}" class="font-medium hover:underline">
                {session.title}
              </a>
